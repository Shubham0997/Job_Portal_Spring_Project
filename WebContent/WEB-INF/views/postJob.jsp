...
<a class="active" href = "/Job_portal_Spring/postJob">Post Job Openings</a>
</sec:authorize>
...
<div class="signup__center">
		<form:form name="postJob" action="process-jobposting"  modelAttribute="postedJobs" method="POST" class="formPost" id="form">
			<h3>Post Job</h3>
			<p />
	
	<form:hidden path="employerUsername" value="${userBean.username}" />
								<form:hidden path="employerEmail" value="${userBean.email}" />
			...
			<div id="nameDiv" class="input-control">
				<form:input path="CompanyName" placeholder="Company Name"
					  required="true" />
						...
						<div id="nameDiv" class="input-control">
				<form:textarea path="Description" rows = "10" cols = "30" required="true" placeholder="Description"></form:textarea>
			
			</div>

			
			
			<button style="color:#080710" type="submit" value="Submit" id="signup" >Post Job</button><br><br><br>
