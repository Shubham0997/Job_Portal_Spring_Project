  ...
  <table>
    ...
    <c:forEach items="${listJobs}" var="jobs">
      <tr>
        ...
        <td class='select'>
          <a class="button" href="/Job_portal_Spring/processapplicants?jobid=${jobs.jobid}"> Show Applicants</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<a class="button" href="/Job_portal_Spring/deletePosting?jobid=${jobs.jobid}"> Delete Posting</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<a class="button" href="/Job_portal_Spring/updatePosting?jobid=${jobs.jobid}&jobName=${jobs.jobName}&companyName=${jobs.companyName}&description=${jobs.description}"> Update Posting</a>
        </td>
      </tr>
     </c:forEach>
